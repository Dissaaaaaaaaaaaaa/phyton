...
luassisi2.grid(row=1, column=1, sticky=W, padx=5, pady=5)
# Textbox Luas Sisi 2 
...
luassisi3.grid(row=2, column=1, sticky=W, padx=5, pady=5)
# Textbox Luas Sisi 3 
...
luassisi4.grid(row=3, column=1, sticky=W, padx=5, pady=5)
# Textbox Luas Sisi 4 
...
luassisi5.grid(row=4, column=1, sticky=W, padx=5, pady=5)
# Textbox Luas Sisi 5 
...
txtluasalas.grid(row=5, column=0)
